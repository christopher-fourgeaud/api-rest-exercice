$(document).ready(function () {
    ...
    $(document).on('click', '.update-product-button', function () {
        ...
        $.getJSON("http://localhost/private/api-exercice/product/read_one.php?id=" + id, function (data) {
            ...
            $.getJSON("http://localhost/private/api-exercice/category/read.php", function (data) {
    ...
    $(document).on('submit', '#update-product-form', function () {
        ...
        $.ajax({
            url: "http://localhost/private/api-exercice/product/update.php",
            type: "POST",
